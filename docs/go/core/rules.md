...
go_binary(<a href="#go_binary-name">name</a>, <a href="#go_binary-deps">deps</a>, <a href="#go_binary-srcs">srcs</a>, <a href="#go_binary-data">data</a>, <a href="#go_binary-out">out</a>, <a href="#go_binary-basename">basename</a>, <a href="#go_binary-cdeps">cdeps</a>, <a href="#go_binary-cgo">cgo</a>, <a href="#go_binary-clinkopts">clinkopts</a>, <a href="#go_binary-copts">copts</a>, <a href="#go_binary-cppopts">cppopts</a>, <a href="#go_binary-cxxopts">cxxopts</a>,
          ...
          <a href="#go_binary-linkshared">linkshared</a>, <a href="#go_binary-msan">msan</a>, <a href="#go_binary-pgoprofile">pgoprofile</a>, <a href="#go_binary-pure">pure</a>, <a href="#go_binary-race">race</a>, <a href="#go_binary-shared_deps">shared_deps</a>, <a href="#go_binary-static">static</a>, <a href="#go_binary-x_defs">x_defs</a>)
</pre>
...
| <a id="go_binary-shared_deps"></a>shared_deps |  List of Go shared libraries to link dynamically when `linkshared` is enabled. These should be `go_shared_library` rules or compatible rules that provide [GoSharedLibraryInfo]. These do not affect compilation.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
go_test(<a href="#go_test-name">name</a>, <a href="#go_test-deps">deps</a>, <a href="#go_test-srcs">srcs</a>, <a href="#go_test-data">data</a>, <a href="#go_test-cdeps">cdeps</a>, <a href="#go_test-cgo">cgo</a>, <a href="#go_test-clinkopts">clinkopts</a>, <a href="#go_test-copts">copts</a>, <a href="#go_test-cppopts">cppopts</a>, <a href="#go_test-cxxopts">cxxopts</a>, <a href="#go_test-embed">embed</a>, <a href="#go_test-embedsrcs">embedsrcs</a>,
        <a href="#go_test-env">env</a>, <a href="#go_test-env_inherit">env_inherit</a>, <a href="#go_test-gc_goopts">gc_goopts</a>, <a href="#go_test-gc_linkopts">gc_linkopts</a>, <a href="#go_test-goarch">goarch</a>, <a href="#go_test-goos">goos</a>, <a href="#go_test-gotags">gotags</a>, <a href="#go_test-importpath">importpath</a>, <a href="#go_test-linkmode">linkmode</a>,
        <a href="#go_test-linkshared">linkshared</a>, <a href="#go_test-msan">msan</a>, <a href="#go_test-pure">pure</a>, <a href="#go_test-race">race</a>, <a href="#go_test-rundir">rundir</a>, <a href="#go_test-shared_deps">shared_deps</a>, <a href="#go_test-static">static</a>, <a href="#go_test-x_defs">x_defs</a>)
</pre>
...
| <a id="go_test-linkshared"></a>linkshared |  Controls whether test binaries are linked against Go shared libraries (like `-linkshared`). May be one of `on`, `off`, or `auto`. If `auto`, this is controlled by `--@io_bazel_rules_go//go/config:linkshared`.   | String | optional |  `"auto"`  |
...
| <a id="go_test-shared_deps"></a>shared_deps |  List of Go shared libraries to link dynamically when `linkshared` is enabled. These should be `go_shared_library` rules or compatible rules that provide [GoSharedLibraryInfo]. These do not affect compilation.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |

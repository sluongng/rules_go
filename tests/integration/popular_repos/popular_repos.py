...
POPULAR_REPOS = [
    ...
    dict(
        ...
        excludes = [
            ...
            "cmd/gonew:gonew_test", # Requires working GOROOT
            ...
            "go/analysis/passes/directive:directive_test", # Requires working GOROOT
            ...
            "internal/cmd/deadcode:deadcode_test", # Requires working GOROOT
